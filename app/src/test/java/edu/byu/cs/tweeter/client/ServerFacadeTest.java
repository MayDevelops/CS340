...
public class ServerFacadeTest {
  ...
  void testGetFollowers() throws IOException, TweeterRemoteException {
    ...
    FollowPageResponse response = ServerFacade.getServerFacade().followPage(request, "/followpage");
    ...
    response = ServerFacade.getServerFacade().followPage(request, "/followpage");
